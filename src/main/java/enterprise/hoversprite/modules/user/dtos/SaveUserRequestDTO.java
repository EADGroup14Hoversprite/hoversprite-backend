...
public class SaveUserRequestDTO {
    ...
    public User toModel() {
        return switch (userRole) {
            case "FARMER" ->
                    new User(fullName, phoneNumber, homeAddress, emailAddress, UserRole.FARMER, username, password);
            case "RECEPTIONIST" ->
                    new User(fullName, phoneNumber, homeAddress, emailAddress, UserRole.RECEPTIONIST, username, password);
            case "SPRAYER" ->
                    new User(fullName, phoneNumber, homeAddress, emailAddress, UserRole.SPRAYER, username, password);
